...
flowchart TD
    ...
    dist_lq(dist_stats_lq) --> est_lq
    gini_lq(gini_lq) --> dist_lq
    value_at_lq(value_at_lq) --> dist_lq
    polarization_lq(polarization_lq) --> dist_lq
    mld_lq(mld_lq) --> dist_lq
    quantile_lq(quantile_lq) --> dist_lq
...
Normality and Validity
 ...
 - $a+d \geq 0.9$ so $L(1,y) = 1$ (Validity) **Need checking (see note)**
